...
// Load 1-seater rooms from MongoDB
async function loadoneSeaterRooms() {
    try {
        const response = await fetch('http://localhost:3000/one_seater_rooms');
...
function viewRoomDetails(roomNumber) {
    window.location.href = `room_details_one.html?room=${roomNumber}`;
}
