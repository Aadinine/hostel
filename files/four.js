...
// Load 4-seater rooms from MongoDB
async function loadFourSeaterRooms() {
    try {
        const response = await fetch('http://localhost:3000/four_seater_rooms');
...
function viewRoomDetails(roomNumber) {
    window.location.href = `room_details_four.html?room=${roomNumber}`;
}
